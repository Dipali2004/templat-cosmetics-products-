   ...
   <?php include 'header.php'; ?>
        ...
        "autoplay": true
                ...
                <!--Hero Item start-->
                <div class="hero-item bg-image" data-bg="assets/images/hero/hero-3.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="hero-content-3">
                                    ...
                                    <h2 style="color: red;">Saloni Buety product Shop <br> padharpur</h2>
                                </div>
                                <!--Hero Content end-->
                ...
                <!--Hero Item start-->
                <div class="hero-item bg-image" data-bg="assets/images/hero/hero-4.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
            ...
            <div class="container-fluid pl-75 pr-75 pl-lg-15 pr-lg-15 pl-md-15 pr-md-15 pl-sm-15 pr-sm-15 pl-xs-15 pr-xs-15">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-xl-10">
                        <div class="product-slider tf-element-carousel product-nav-two" data-slick-options='{
                            "slidesToShow": 5,
                            "slidesToScroll": 1,
                            "infinite": true,
                            "arrows": true,
        ...
        <div
            class="banner-section section bg-image pt-95 pt-lg-75 pt-md-65 pt-sm-55 pt-xs-45 pb-95 pb-lg-75 pb-md-65 pb-sm-55 pb-xs-45" data-bg="assets/images/banner/img_bannermid.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="section-title mb-40 mb-xs-20">
                            <h2 style="text-align: center; font-style:bold; font-size: 30px; color:red;">From the blog</h2>
                        </div>
                    </div>
                    <!-- Section Title End -->
                </div>
