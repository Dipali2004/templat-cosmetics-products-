                ...
                <div class="container">
                    <div class="row row-25">
                        ...
                        <div class="footer-widget col-lg-3 col-md-6 col-sm-6 col-12 mb-40 mb-xs-35">
                            ...
                            <ul class="address">
                                <li><i class="fa fa-home"></i><span>pandharpur </span>
                                </li>
                                <li><i class="fa fa-phone"></i><span><a href="#">91+ 8010331634</a></span></li>
                                <li><i class="fa fa-envelope-o"></i><span><a href="#">dipalishinde@gamil.com</a></span></li>
                            </ul>
